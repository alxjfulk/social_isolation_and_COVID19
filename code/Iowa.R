...
adep_var_1 <- anxiety_1 %>% filter(geo_value == 'ia')
ddep_var_1 <- depression_1 %>% filter(geo_value == 'ia')
adep_var_2 <- anxiety_2 %>% filter(geo_value == 'ia')
ddep_var_2 <- depression_2 %>% filter(geo_value == 'ia')
...
write.csv(tp1data, "C:/Users/a426f262/OneDrive - University of Kansas/Desktop/School/Research/COVID-19 and Mental Health/code + results/results/data/Iowa1.csv",row.names = FALSE)
write.csv(tp2data, "C:/Users/a426f262/OneDrive - University of Kansas/Desktop/School/Research/COVID-19 and Mental Health/code + results/results/data/Iowa2.csv",row.names = FALSE)
###### Run models ##
####FIRST TIME PERIOD###
#save J test results
...
sink('irfIowa1_death.txt')
print(irfresult1_death)
sink()
#
sink('irfIowa1_incidence.txt')
print(irfresult1_incidence)
sink()
#
sink('irfIowa1_work.txt')
print(irfresult1_work)
sink()
#
sink('irfIowa1_spent.txt')
...
pdf('irfIowa1_death.pdf')
plot(irfresult1_death)
dev.off()
# tiff('irfIowa1_death.tiff', res = 300)
# plot(irfresult1_death)
# dev.off()
#
pdf('irfIowa1_incidence.pdf')
plot(irfresult1_incidence)
dev.off()
# tiff('irfIowa1_incidence.tiff', res = 300)
# plot(irfresult1_incidence)
# dev.off()
#
pdf('irfIowa1_work.pdf')
plot(irfresult1_work)
dev.off()
# tiff('irfIowa1_work.tiff', res = 300)
# plot(irfresult1_work)
# dev.off()
#
pdf('irfIowa1_spent.pdf')
plot(irfresult1_spent)
dev.off()
# tiff('irfIowa1_spent.tiff', res = 300)
# plot(irfresult1_spent)
# dev.off()
...
#irfresult1 = irf(mdl1, boot = FALSE)
setwd("C:/Users/a426f262/OneDrive - University of Kansas/Desktop/School/Research/COVID-19 and Mental Health/code + results/results/IRF coeffs")
sink('irfIowa2_death.txt')
print(irfresult2_death)
sink()
#
sink('irfIowa2_incidence.txt')
print(irfresult2_incidence)
sink()
#
sink('irfIowa2_work.txt')
print(irfresult2_work)
sink()
#
sink('irfIowa2_spent.txt')
print(irfresult2_spent)
sink()
#
sink('irfIowa2_vac.txt')
...
#after running line: plot(irfresult1)
setwd("C:/Users/a426f262/OneDrive - University of Kansas/Desktop/School/Research/COVID-19 and Mental Health/code + results/results/IRF")
pdf('irfIowa2_death.pdf')
plot(irfresult2_death)
dev.off()
# tiff('irfIowa2_death.tiff', res = 300)
# plot(irfresult2_death)
# dev.off()
#
pdf('irfIowa2_incidence.pdf')
plot(irfresult2_incidence)
dev.off()
# tiff('irfIowa2_incidence.tiff', res = 300)
# plot(irfresult2_incidence)
# dev.off()
#
pdf('irfIowa2_work.pdf')
plot(irfresult2_work)
dev.off()
# tiff('irfIowa2_work.tiff', res = 300)
# plot(irfresult2_work)
# dev.off()
#
pdf('irfIowa2_spent.pdf')
plot(irfresult2_spent)
dev.off()
# tiff('irfIowa2_spent.tiff', res = 300)
# plot(irfresult2_spent)
# dev.off()
#
pdf('irfIowa2_vac.pdf')
plot(irfresult2_vac)
dev.off()
# tiff('irfIowa2_vac.tiff', res = 300)
# plot(irfresult2_vac)
# dev.off()
