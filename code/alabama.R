...
adep_var_1 <- anxiety_1 %>% filter(geo_value == 'al')
ddep_var_1 <- depression_1 %>% filter(geo_value == 'al')
adep_var_2 <- anxiety_2 %>% filter(geo_value == 'al')
ddep_var_2 <- depression_2 %>% filter(geo_value == 'al')
...
write.csv(tp1data, "C:/Users/a426f262/OneDrive - University of Kansas/Desktop/School/Research/COVID-19 and Mental Health/code + results/results/data/alabama1.csv",row.names = FALSE)
write.csv(tp2data, "C:/Users/a426f262/OneDrive - University of Kansas/Desktop/School/Research/COVID-19 and Mental Health/code + results/results/data/alabama2.csv",row.names = FALSE)
###### Run models ######
####FIRST TIME PERIOD####
#save J test results
...
irfresult1_death = irf(mdl1_death, n.ahead = 20)
irfresult1_incidence = irf(mdl1_incidence, n.ahead = 20)
irfresult1_work = irf(mdl1_work, n.ahead = 20)
irfresult1_spent = irf(mdl1_spent, n.ahead = 20)
...
sink('irfalabama1_death.txt')
print(irfresult1_death)
sink()
#
sink('irfalabama1_incidence.txt')
print(irfresult1_incidence)
sink()
#
sink('irfalabama1_work.txt')
print(irfresult1_work)
sink()
#
sink('irfalabama1_spent.txt')
...
pdf('irfalabama1_death.pdf')
plot(irfresult1_death)
dev.off()
#
pdf('irfalabama1_incidence.pdf')
plot(irfresult1_incidence)
dev.off()
#
pdf('irfalabama1_work.pdf')
plot(irfresult1_work)
dev.off()
#
pdf('irfalabama1_spent.pdf')
...
irfresult2_death = irf(mdl2_death, n.ahead = 20)
irfresult2_incidence = irf(mdl2_incidence, n.ahead = 20)
irfresult2_work = irf(mdl2_work, n.ahead = 20)
irfresult2_spent = irf(mdl2_spent, n.ahead = 20)
irfresult2_vac = irf(mdl2_vac, n.ahead = 20)
#irfresult1 = irf(mdl1, boot = FALSE)
setwd("C:/Users/a426f262/OneDrive - University of Kansas/Desktop/School/Research/COVID-19 and Mental Health/code + results/results/IRF coeffs")
sink('irfalabama2_death.txt')
print(irfresult2_death)
sink()
#
sink('irfalabama2_incidence.txt')
print(irfresult2_incidence)
sink()
#
sink('irfalabama2_work.txt')
print(irfresult2_work)
sink()
#
sink('irfalabama2_spent.txt')
print(irfresult2_spent)
sink()
#
sink('irfalabama2_vac.txt')
print(irfresult2_vac)
sink()
#save the irf plots. You'll need to hit enter in the console a few times to get all of the plots to save
#after running line: plot(irfresult1)
setwd("C:/Users/a426f262/OneDrive - University of Kansas/Desktop/School/Research/COVID-19 and Mental Health/code + results/results/IRF")
pdf('irfalabama2_death.pdf')
plot(irfresult2_death)
dev.off()
#
pdf('irfalabama2_incidence.pdf')
plot(irfresult2_incidence)
dev.off()
#
pdf('irfalabama2_work.pdf')
plot(irfresult2_work)
dev.off()
#
pdf('irfalabama2_spent.pdf')
plot(irfresult2_spent)
dev.off()
#
pdf('irfalabama2_vac.pdf')
plot(irfresult2_vac)
dev.off()
#save model coefficients
setwd("C:/Users/a426f262/OneDrive - University of Kansas/Desktop/School/Research/COVID-19 and Mental Health/code + results/results/Coefficients")
sink('Coeffalabama2.txt')
