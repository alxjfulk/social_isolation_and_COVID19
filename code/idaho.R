...
adep_var_1 <- anxiety_1 %>% filter(geo_value == 'id')
ddep_var_1 <- depression_1 %>% filter(geo_value == 'id')
adep_var_2 <- anxiety_2 %>% filter(geo_value == 'id')
ddep_var_2 <- depression_2 %>% filter(geo_value == 'id')
...
write.csv(tp1data, "C:/Users/a426f262/OneDrive - University of Kansas/Desktop/School/Research/COVID-19 and Mental Health/code + results/results/data/Idaho1.csv",row.names = FALSE)
write.csv(tp2data, "C:/Users/a426f262/OneDrive - University of Kansas/Desktop/School/Research/COVID-19 and Mental Health/code + results/results/data/Idaho2.csv",row.names = FALSE)
###### Run models ##
####FIRST TIME PERIOD###
#save J test results
...
sink('irfIdaho1_death.txt')
print(irfresult1_death)
sink()
#
sink('irfIdaho1_incidence.txt')
print(irfresult1_incidence)
sink()
#
sink('irfIdaho1_work.txt')
print(irfresult1_work)
sink()
#
sink('irfIdaho1_spent.txt')
...
pdf('irfIdaho1_death.pdf')
plot(irfresult1_death)
dev.off()
# tiff('irfIdaho1_death.tiff', res = 300)
# plot(irfresult1_death)
# dev.off()
#
pdf('irfIdaho1_incidence.pdf')
plot(irfresult1_incidence)
dev.off()
# tiff('irfIdaho1_incidence.tiff', res = 300)
# plot(irfresult1_incidence)
# dev.off()
#
pdf('irfIdaho1_work.pdf')
plot(irfresult1_work)
dev.off()
# tiff('irfIdaho1_work.tiff', res = 300)
# plot(irfresult1_work)
# dev.off()
#
pdf('irfIdaho1_spent.pdf')
plot(irfresult1_spent)
dev.off()
# tiff('irfIdaho1_spent.tiff', res = 300)
# plot(irfresult1_spent)
# dev.off()
...
#irfresult1 = irf(mdl1, boot = FALSE)
setwd("C:/Users/a426f262/OneDrive - University of Kansas/Desktop/School/Research/COVID-19 and Mental Health/code + results/results/IRF coeffs")
sink('irfIdaho2_death.txt')
print(irfresult2_death)
sink()
#
sink('irfIdaho2_incidence.txt')
print(irfresult2_incidence)
sink()
#
sink('irfIdaho2_work.txt')
print(irfresult2_work)
sink()
#
sink('irfIdaho2_spent.txt')
print(irfresult2_spent)
sink()
#
sink('irfIdaho2_vac.txt')
...
#after running line: plot(irfresult1)
setwd("C:/Users/a426f262/OneDrive - University of Kansas/Desktop/School/Research/COVID-19 and Mental Health/code + results/results/IRF")
pdf('irfIdaho2_death.pdf')
plot(irfresult2_death)
dev.off()
# tiff('irfIdaho2_death.tiff', res = 300)
# plot(irfresult2_death)
# dev.off()
#
pdf('irfIdaho2_incidence.pdf')
plot(irfresult2_incidence)
dev.off()
# tiff('irfIdaho2_incidence.tiff', res = 300)
# plot(irfresult2_incidence)
# dev.off()
#
pdf('irfIdaho2_work.pdf')
plot(irfresult2_work)
dev.off()
# tiff('irfIdaho2_work.tiff', res = 300)
# plot(irfresult2_work)
# dev.off()
#
pdf('irfIdaho2_spent.pdf')
plot(irfresult2_spent)
dev.off()
# tiff('irfIdaho2_spent.tiff', res = 300)
# plot(irfresult2_spent)
# dev.off()
#
pdf('irfIdaho2_vac.pdf')
plot(irfresult2_vac)
dev.off()
# tiff('irfIdaho2_vac.tiff', res = 300)
# plot(irfresult2_vac)
# dev.off()

#save model coefficients
setwd("C:/Users/a426f262/OneDrive - University of Kansas/Desktop/School/Research/COVID-19 and Mental Health/code + results/results/Coefficients")
sink('CoeffIdaho2.txt')
