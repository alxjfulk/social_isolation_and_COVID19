...
adep_var_1 <- anxiety_1 %>% filter(geo_value == 'il')
ddep_var_1 <- depression_1 %>% filter(geo_value == 'il')
adep_var_2 <- anxiety_2 %>% filter(geo_value == 'il')
ddep_var_2 <- depression_2 %>% filter(geo_value == 'il')
...
write.csv(tp1data, "C:/Users/a426f262/OneDrive - University of Kansas/Desktop/School/Research/COVID-19 and Mental Health/code + results/results/data/Illinois1.csv",row.names = FALSE)
write.csv(tp2data, "C:/Users/a426f262/OneDrive - University of Kansas/Desktop/School/Research/COVID-19 and Mental Health/code + results/results/data/Illinois2.csv",row.names = FALSE)
###### Run models ##
####FIRST TIME PERIOD###
#save J test results
...
sink('irfIllinois1_death.txt')
print(irfresult1_death)
sink()
#
sink('irfIllinois1_incidence.txt')
print(irfresult1_incidence)
sink()
#
sink('irfIllinois1_work.txt')
print(irfresult1_work)
sink()
#
sink('irfIllinois1_spent.txt')
...
pdf('irfIllinois1_death.pdf')
plot(irfresult1_death)
dev.off()
# tiff('irfIllinois1_death.tiff', res = 300)
# plot(irfresult1_death)
# dev.off()
#
pdf('irfIllinois1_incidence.pdf')
plot(irfresult1_incidence)
dev.off()
# tiff('irfIllinois1_incidence.tiff', res = 300)
# plot(irfresult1_incidence)
# dev.off()
#
pdf('irfIllinois1_work.pdf')
plot(irfresult1_work)
dev.off()
# tiff('irfIllinois1_work.tiff', res = 300)
# plot(irfresult1_work)
# dev.off()
#
pdf('irfIllinois1_spent.pdf')
plot(irfresult1_spent)
dev.off()
# tiff('irfIllinois1_spent.tiff', res = 300)
# plot(irfresult1_spent)
# dev.off()
...
#irfresult1 = irf(mdl1, boot = FALSE)
setwd("C:/Users/a426f262/OneDrive - University of Kansas/Desktop/School/Research/COVID-19 and Mental Health/code + results/results/IRF coeffs")
sink('irfIllinois2_death.txt')
print(irfresult2_death)
sink()
#
sink('irfIllinois2_incidence.txt')
print(irfresult2_incidence)
sink()
#
sink('irfIllinois2_work.txt')
print(irfresult2_work)
sink()
#
sink('irfIllinois2_spent.txt')
print(irfresult2_spent)
sink()
#
sink('irfIllinois2_vac.txt')
...
#after running line: plot(irfresult1)
setwd("C:/Users/a426f262/OneDrive - University of Kansas/Desktop/School/Research/COVID-19 and Mental Health/code + results/results/IRF")
pdf('irfIllinois2_death.pdf')
plot(irfresult2_death)
dev.off()
# tiff('irfIllinois2_death.tiff', res = 300)
# plot(irfresult2_death)
# dev.off()
#
pdf('irfIllinois2_incidence.pdf')
plot(irfresult2_incidence)
dev.off()
# tiff('irfIllinois2_incidence.tiff', res = 300)
# plot(irfresult2_incidence)
# dev.off()
#
pdf('irfIllinois2_work.pdf')
plot(irfresult2_work)
dev.off()
# tiff('irfIllinois2_work.tiff', res = 300)
# plot(irfresult2_work)
# dev.off()
#
pdf('irfIllinois2_spent.pdf')
plot(irfresult2_spent)
dev.off()
# tiff('irfIllinois2_spent.tiff', res = 300)
# plot(irfresult2_spent)
# dev.off()
#
pdf('irfIllinois2_vac.pdf')
plot(irfresult2_vac)
dev.off()
# tiff('irfIllinois2_vac.tiff', res = 300)
# plot(irfresult2_vac)
# dev.off()

#save model coefficients
setwd("C:/Users/a426f262/OneDrive - University of Kansas/Desktop/School/Research/COVID-19 and Mental Health/code + results/results/Coefficients")
sink('CoeffIllinois2.txt')
