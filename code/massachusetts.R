...
adep_var_1 <- anxiety_1 %>% filter(geo_value == 'ma')
ddep_var_1 <- depression_1 %>% filter(geo_value == 'ma')
adep_var_2 <- anxiety_2 %>% filter(geo_value == 'ma')
ddep_var_2 <- depression_2 %>% filter(geo_value == 'ma')
...
write.csv(tp1data, "C:/Users/a426f262/OneDrive - University of Kansas/Desktop/School/Research/COVID-19 and Mental Health/code + results/results/data/Massachusetts1.csv",row.names = FALSE)
write.csv(tp2data, "C:/Users/a426f262/OneDrive - University of Kansas/Desktop/School/Research/COVID-19 and Mental Health/code + results/results/data/Massachusetts2.csv",row.names = FALSE)
###### Run models ##
####FIRST TIME PERIOD###
#save J test results
...
sink('irfMassachusetts1_death.txt')
print(irfresult1_death)
sink()
#
sink('irfMassachusetts1_incidence.txt')
print(irfresult1_incidence)
sink()
#
sink('irfMassachusetts1_work.txt')
print(irfresult1_work)
sink()
#
sink('irfMassachusetts1_spent.txt')
...
pdf('irfMassachusetts1_death.pdf')
plot(irfresult1_death)
dev.off()
# tiff('irfMassachusetts1_death.tiff', res = 300)
# plot(irfresult1_death)
# dev.off()
#
pdf('irfMassachusetts1_incidence.pdf')
plot(irfresult1_incidence)
dev.off()
# tiff('irfMassachusetts1_incidence.tiff', res = 300)
# plot(irfresult1_incidence)
# dev.off()
#
pdf('irfMassachusetts1_work.pdf')
plot(irfresult1_work)
dev.off()
# tiff('irfMassachusetts1_work.tiff', res = 300)
# plot(irfresult1_work)
# dev.off()
#
pdf('irfMassachusetts1_spent.pdf')
plot(irfresult1_spent)
dev.off()
# tiff('irfMassachusetts1_spent.tiff', res = 300)
# plot(irfresult1_spent)
# dev.off()
...
irfresult2_death = irf(mdl2_death, n.ahead = 20, impulse = 'deathCumProp_2', boot = FALSE)
irfresult2_incidence = irf(mdl2_incidence, n.ahead = 20, impulse = 'incidenceProp_2', boot = FALSE)
irfresult2_work = irf(mdl2_work, n.ahead = 20, impulse = 'workOutsideHomeIndoors', boot = FALSE)
irfresult2_spent = irf(mdl2_spent, n.ahead = 20, impulse = 'spentTimeIndoors', boot = FALSE)
irfresult2_vac = irf(mdl2_vac, n.ahead = 20, impulse = 'covidVaccinated', boot = FALSE)
#irfresult1 = irf(mdl1, boot = FALSE)
setwd("C:/Users/a426f262/OneDrive - University of Kansas/Desktop/School/Research/COVID-19 and Mental Health/code + results/results/IRF coeffs")
sink('irfMassachusetts2_death.txt')
print(irfresult2_death)
sink()
#
sink('irfMassachusetts2_incidence.txt')
print(irfresult2_incidence)
sink()
#
sink('irfMassachusetts2_work.txt')
print(irfresult2_work)
sink()
#
sink('irfMassachusetts2_spent.txt')
print(irfresult2_spent)
sink()
#
sink('irfMassachusetts2_vac.txt')
...
#after running line: plot(irfresult1)
setwd("C:/Users/a426f262/OneDrive - University of Kansas/Desktop/School/Research/COVID-19 and Mental Health/code + results/results/IRF")
pdf('irfMassachusetts2_death.pdf')
plot(irfresult2_death)
dev.off()
# tiff('irfMassachusetts2_death.tiff', res = 300)
# plot(irfresult2_death)
# dev.off()
#
pdf('irfMassachusetts2_incidence.pdf')
plot(irfresult2_incidence)
dev.off()
# tiff('irfMassachusetts2_incidence.tiff', res = 300)
# plot(irfresult2_incidence)
# dev.off()
#
pdf('irfMassachusetts2_work.pdf')
plot(irfresult2_work)
dev.off()
# tiff('irfMassachusetts2_work.tiff', res = 300)
# plot(irfresult2_work)
# dev.off()
#
pdf('irfMassachusetts2_spent.pdf')
plot(irfresult2_spent)
dev.off()
# tiff('irfMassachusetts2_spent.tiff', res = 300)
# plot(irfresult2_spent)
# dev.off()
#
pdf('irfMassachusetts2_vac.pdf')
plot(irfresult2_vac)
dev.off()
# tiff('irfMassachusetts2_vac.tiff', res = 300)
# plot(irfresult2_vac)
# dev.off()

#save model coefficients
setwd("C:/Users/a426f262/OneDrive - University of Kansas/Desktop/School/Research/COVID-19 and Mental Health/code + results/results/Coefficients")
sink('CoeffMassachusetts2.txt')
