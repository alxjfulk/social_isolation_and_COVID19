...
adep_var_1 <- anxiety_1 %>% filter(geo_value == 'nd')
ddep_var_1 <- depression_1 %>% filter(geo_value == 'nd')
adep_var_2 <- anxiety_2 %>% filter(geo_value == 'nd')
ddep_var_2 <- depression_2 %>% filter(geo_value == 'nd')
...
write.csv(tp1data, "C:/Users/a426f262/OneDrive - University of Kansas/Desktop/School/Research/COVID-19 and Mental Health/code + results/results/data/NorthDakota1.csv",row.names = FALSE)
write.csv(tp2data, "C:/Users/a426f262/OneDrive - University of Kansas/Desktop/School/Research/COVID-19 and Mental Health/code + results/results/data/NorthDakota2.csv",row.names = FALSE)
###### Run models ##
####FIRST TIME PERIOD###
#save J test results
...
sink('irfNorthDakota1_death.txt')
print(irfresult1_death)
sink()
#
sink('irfNorthDakota1_incidence.txt')
print(irfresult1_incidence)
sink()
#
sink('irfNorthDakota1_work.txt')
print(irfresult1_work)
sink()
#
sink('irfNorthDakota1_spent.txt')
...
pdf('irfNorthDakota1_death.pdf')
plot(irfresult1_death)
dev.off()
# tiff('irfNorthDakota1_death.tiff', res = 300)
# plot(irfresult1_death)
# dev.off()
#
pdf('irfNorthDakota1_incidence.pdf')
plot(irfresult1_incidence)
dev.off()
# tiff('irfNorthDakota1_incidence.tiff', res = 300)
# plot(irfresult1_incidence)
# dev.off()
#
pdf('irfNorthDakota1_work.pdf')
plot(irfresult1_work)
dev.off()
# tiff('irfNorthDakota1_work.tiff', res = 300)
# plot(irfresult1_work)
# dev.off()
#
pdf('irfNorthDakota1_spent.pdf')
plot(irfresult1_spent)
dev.off()
# tiff('irfNorthDakota1_spent.tiff', res = 300)
# plot(irfresult1_spent)
# dev.off()
...
#irfresult1 = irf(mdl1, boot = FALSE)
setwd("C:/Users/a426f262/OneDrive - University of Kansas/Desktop/School/Research/COVID-19 and Mental Health/code + results/results/IRF coeffs")
sink('irfNorthDakota2_death.txt')
print(irfresult2_death)
sink()
#
sink('irfNorthDakota2_incidence.txt')
print(irfresult2_incidence)
sink()
#
sink('irfNorthDakota2_work.txt')
print(irfresult2_work)
sink()
#
sink('irfNorthDakota2_spent.txt')
print(irfresult2_spent)
sink()
#
sink('irfNorthDakota2_vac.txt')
...
#after running line: plot(irfresult1)
setwd("C:/Users/a426f262/OneDrive - University of Kansas/Desktop/School/Research/COVID-19 and Mental Health/code + results/results/IRF")
pdf('irfNorthDakota2_death.pdf')
plot(irfresult2_death)
dev.off()
# tiff('irfNorthDakota2_death.tiff', res = 300)
# plot(irfresult2_death)
# dev.off()
#
pdf('irfNorthDakota2_incidence.pdf')
plot(irfresult2_incidence)
dev.off()
# tiff('irfNorthDakota2_incidence.tiff', res = 300)
# plot(irfresult2_incidence)
# dev.off()
#
pdf('irfNorthDakota2_work.pdf')
plot(irfresult2_work)
dev.off()
# tiff('irfNorthDakota2_work.tiff', res = 300)
# plot(irfresult2_work)
# dev.off()
#
pdf('irfNorthDakota2_spent.pdf')
plot(irfresult2_spent)
dev.off()
# tiff('irfNorthDakota2_spent.tiff', res = 300)
# plot(irfresult2_spent)
# dev.off()
#
pdf('irfNorthDakota2_vac.pdf')
plot(irfresult2_vac)
dev.off()
# tiff('irfNorthDakota2_vac.tiff', res = 300)
# plot(irfresult2_vac)
# dev.off()

#save model coefficients
setwd("C:/Users/a426f262/OneDrive - University of Kansas/Desktop/School/Research/COVID-19 and Mental Health/code + results/results/Coefficients")
sink('CoeffNorthDakota2.txt')
