...
adep_var_1 <- anxiety_1 %>% filter(geo_value == 'oh')
ddep_var_1 <- depression_1 %>% filter(geo_value == 'oh')
adep_var_2 <- anxiety_2 %>% filter(geo_value == 'oh')
ddep_var_2 <- depression_2 %>% filter(geo_value == 'oh')
...
write.csv(tp1data, "C:/Users/a426f262/OneDrive - University of Kansas/Desktop/School/Research/COVID-19 and Mental Health/code + results/results/data/Ohio1.csv",row.names = FALSE)
write.csv(tp2data, "C:/Users/a426f262/OneDrive - University of Kansas/Desktop/School/Research/COVID-19 and Mental Health/code + results/results/data/Ohio2.csv",row.names = FALSE)
###### Run models ##
####FIRST TIME PERIOD###
#save J test results
...
sink('irfOhio1_death.txt')
print(irfresult1_death)
sink()
#
sink('irfOhio1_incidence.txt')
print(irfresult1_incidence)
sink()
#
sink('irfOhio1_work.txt')
print(irfresult1_work)
sink()
#
sink('irfOhio1_spent.txt')
...
pdf('irfOhio1_death.pdf')
plot(irfresult1_death)
dev.off()
# tiff('irfOhio1_death.tiff', res = 300)
# plot(irfresult1_death)
# dev.off()
#
pdf('irfOhio1_incidence.pdf')
plot(irfresult1_incidence)
dev.off()
# tiff('irfOhio1_incidence.tiff', res = 300)
# plot(irfresult1_incidence)
# dev.off()
#
pdf('irfOhio1_work.pdf')
plot(irfresult1_work)
dev.off()
# tiff('irfOhio1_work.tiff', res = 300)
# plot(irfresult1_work)
# dev.off()
#
pdf('irfOhio1_spent.pdf')
plot(irfresult1_spent)
dev.off()
# tiff('irfOhio1_spent.tiff', res = 300)
# plot(irfresult1_spent)
# dev.off()
...
#irfresult1 = irf(mdl1, boot = FALSE)
setwd("C:/Users/a426f262/OneDrive - University of Kansas/Desktop/School/Research/COVID-19 and Mental Health/code + results/results/IRF coeffs")
sink('irfOhio2_death.txt')
print(irfresult2_death)
sink()
#
sink('irfOhio2_incidence.txt')
print(irfresult2_incidence)
sink()
#
sink('irfOhio2_work.txt')
print(irfresult2_work)
sink()
#
sink('irfOhio2_spent.txt')
print(irfresult2_spent)
sink()
#
sink('irfOhio2_vac.txt')
...
#after running line: plot(irfresult1)
setwd("C:/Users/a426f262/OneDrive - University of Kansas/Desktop/School/Research/COVID-19 and Mental Health/code + results/results/IRF")
pdf('irfOhio2_death.pdf')
plot(irfresult2_death)
dev.off()
# tiff('irfOhio2_death.tiff', res = 300)
# plot(irfresult2_death)
# dev.off()
#
pdf('irfOhio2_incidence.pdf')
plot(irfresult2_incidence)
dev.off()
# tiff('irfOhio2_incidence.tiff', res = 300)
# plot(irfresult2_incidence)
# dev.off()
#
pdf('irfOhio2_work.pdf')
plot(irfresult2_work)
dev.off()
# tiff('irfOhio2_work.tiff', res = 300)
# plot(irfresult2_work)
# dev.off()
#
pdf('irfOhio2_spent.pdf')
plot(irfresult2_spent)
dev.off()
# tiff('irfOhio2_spent.tiff', res = 300)
# plot(irfresult2_spent)
# dev.off()
#
pdf('irfOhio2_vac.pdf')
plot(irfresult2_vac)
dev.off()
# tiff('irfOhio2_vac.tiff', res = 300)
# plot(irfresult2_vac)
# dev.off()
