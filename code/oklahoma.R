...
adep_var_1 <- anxiety_1 %>% filter(geo_value == 'ok')
ddep_var_1 <- depression_1 %>% filter(geo_value == 'ok')
adep_var_2 <- anxiety_2 %>% filter(geo_value == 'ok')
ddep_var_2 <- depression_2 %>% filter(geo_value == 'ok')
...
write.csv(tp1data, "C:/Users/a426f262/OneDrive - University of Kansas/Desktop/School/Research/COVID-19 and Mental Health/code + results/results/data/Oklahoma1.csv",row.names = FALSE)
write.csv(tp2data, "C:/Users/a426f262/OneDrive - University of Kansas/Desktop/School/Research/COVID-19 and Mental Health/code + results/results/data/Oklahoma2.csv",row.names = FALSE)
###### Run models ##
####FIRST TIME PERIOD###
#save J test results
...
sink('irfOklahoma1_death.txt')
print(irfresult1_death)
sink()
#
sink('irfOklahoma1_incidence.txt')
print(irfresult1_incidence)
sink()
#
sink('irfOklahoma1_work.txt')
print(irfresult1_work)
sink()
#
sink('irfOklahoma1_spent.txt')
...
pdf('irfOklahoma1_death.pdf')
plot(irfresult1_death)
dev.off()
# tiff('irfOklahoma1_death.tiff', res = 300)
# plot(irfresult1_death)
# dev.off()
#
pdf('irfOklahoma1_incidence.pdf')
plot(irfresult1_incidence)
dev.off()
# tiff('irfOklahoma1_incidence.tiff', res = 300)
# plot(irfresult1_incidence)
# dev.off()
#
pdf('irfOklahoma1_work.pdf')
plot(irfresult1_work)
dev.off()
# tiff('irfOklahoma1_work.tiff', res = 300)
# plot(irfresult1_work)
# dev.off()
#
pdf('irfOklahoma1_spent.pdf')
plot(irfresult1_spent)
dev.off()
# tiff('irfOklahoma1_spent.tiff', res = 300)
# plot(irfresult1_spent)
# dev.off()
...
#irfresult1 = irf(mdl1, boot = FALSE)
setwd("C:/Users/a426f262/OneDrive - University of Kansas/Desktop/School/Research/COVID-19 and Mental Health/code + results/results/IRF coeffs")
sink('irfOklahoma2_death.txt')
print(irfresult2_death)
sink()
#
sink('irfOklahoma2_incidence.txt')
print(irfresult2_incidence)
sink()
#
sink('irfOklahoma2_work.txt')
print(irfresult2_work)
sink()
#
sink('irfOklahoma2_spent.txt')
print(irfresult2_spent)
sink()
#
sink('irfOklahoma2_vac.txt')
...
#after running line: plot(irfresult1)
setwd("C:/Users/a426f262/OneDrive - University of Kansas/Desktop/School/Research/COVID-19 and Mental Health/code + results/results/IRF")
pdf('irfOklahoma2_death.pdf')
plot(irfresult2_death)
dev.off()
# tiff('irfOklahoma2_death.tiff', res = 300)
# plot(irfresult2_death)
# dev.off()
#
pdf('irfOklahoma2_incidence.pdf')
plot(irfresult2_incidence)
dev.off()
# tiff('irfOklahoma2_incidence.tiff', res = 300)
# plot(irfresult2_incidence)
# dev.off()
#
pdf('irfOklahoma2_work.pdf')
plot(irfresult2_work)
dev.off()
# tiff('irfOklahoma2_work.tiff', res = 300)
# plot(irfresult2_work)
# dev.off()
#
pdf('irfOklahoma2_spent.pdf')
plot(irfresult2_spent)
dev.off()
# tiff('irfOklahoma2_spent.tiff', res = 300)
# plot(irfresult2_spent)
# dev.off()
#
pdf('irfOklahoma2_vac.pdf')
plot(irfresult2_vac)
dev.off()
# tiff('irfOklahoma2_vac.tiff', res = 300)
# plot(irfresult2_vac)
# dev.off()

#save model coefficients
setwd("C:/Users/a426f262/OneDrive - University of Kansas/Desktop/School/Research/COVID-19 and Mental Health/code + results/results/Coefficients")
sink('CoeffOklahoma2.txt')
