...
adep_var_1 <- anxiety_1 %>% filter(geo_value == 'or')
ddep_var_1 <- depression_1 %>% filter(geo_value == 'or')
adep_var_2 <- anxiety_2 %>% filter(geo_value == 'or')
ddep_var_2 <- depression_2 %>% filter(geo_value == 'or')
...
write.csv(tp1data, "C:/Users/a426f262/OneDrive - University of Kansas/Desktop/School/Research/COVID-19 and Mental Health/code + results/results/data/Oregon1.csv",row.names = FALSE)
write.csv(tp2data, "C:/Users/a426f262/OneDrive - University of Kansas/Desktop/School/Research/COVID-19 and Mental Health/code + results/results/data/Oregon2.csv",row.names = FALSE)
###### Run models ##
####FIRST TIME PERIOD###
#save J test results
...
sink('irfOregon1_death.txt')
print(irfresult1_death)
sink()
#
sink('irfOregon1_incidence.txt')
print(irfresult1_incidence)
sink()
#
sink('irfOregon1_work.txt')
print(irfresult1_work)
sink()
#
sink('irfOregon1_spent.txt')
...
pdf('irfOregon1_death.pdf')
plot(irfresult1_death)
dev.off()
# tiff('irfOregon1_death.tiff', res = 300)
# plot(irfresult1_death)
# dev.off()
#
pdf('irfOregon1_incidence.pdf')
plot(irfresult1_incidence)
dev.off()
# tiff('irfOregon1_incidence.tiff', res = 300)
# plot(irfresult1_incidence)
# dev.off()
#
pdf('irfOregon1_work.pdf')
plot(irfresult1_work)
dev.off()
# tiff('irfOregon1_work.tiff', res = 300)
# plot(irfresult1_work)
# dev.off()
#
pdf('irfOregon1_spent.pdf')
plot(irfresult1_spent)
dev.off()
# tiff('irfOregon1_spent.tiff', res = 300)
# plot(irfresult1_spent)
# dev.off()
...
#irfresult1 = irf(mdl1, boot = FALSE)
setwd("C:/Users/a426f262/OneDrive - University of Kansas/Desktop/School/Research/COVID-19 and Mental Health/code + results/results/IRF coeffs")
sink('irfOregon2_death.txt')
print(irfresult2_death)
sink()
#
sink('irfOregon2_incidence.txt')
print(irfresult2_incidence)
sink()
#
sink('irfOregon2_work.txt')
print(irfresult2_work)
sink()
#
sink('irfOregon2_spent.txt')
print(irfresult2_spent)
sink()
#
sink('irfOregon2_vac.txt')
...
#after running line: plot(irfresult1)
setwd("C:/Users/a426f262/OneDrive - University of Kansas/Desktop/School/Research/COVID-19 and Mental Health/code + results/results/IRF")
pdf('irfOregon2_death.pdf')
plot(irfresult2_death)
dev.off()
# tiff('irfOregon2_death.tiff', res = 300)
# plot(irfresult2_death)
# dev.off()
#
pdf('irfOregon2_incidence.pdf')
plot(irfresult2_incidence)
dev.off()
# tiff('irfOregon2_incidence.tiff', res = 300)
# plot(irfresult2_incidence)
# dev.off()
#
pdf('irfOregon2_work.pdf')
plot(irfresult2_work)
dev.off()
# tiff('irfOregon2_work.tiff', res = 300)
# plot(irfresult2_work)
# dev.off()
#
pdf('irfOregon2_spent.pdf')
plot(irfresult2_spent)
dev.off()
# tiff('irfOregon2_spent.tiff', res = 300)
# plot(irfresult2_spent)
# dev.off()
#
pdf('irfOregon2_vac.pdf')
plot(irfresult2_vac)
dev.off()
# tiff('irfOregon2_vac.tiff', res = 300)
# plot(irfresult2_vac)
# dev.off()

#save model coefficients
setwd("C:/Users/a426f262/OneDrive - University of Kansas/Desktop/School/Research/COVID-19 and Mental Health/code + results/results/Coefficients")
sink('CoeffOregon2.txt')
