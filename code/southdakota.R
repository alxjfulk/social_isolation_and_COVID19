...
adep_var_1 <- anxiety_1 %>% filter(geo_value == 'sd')
ddep_var_1 <- depression_1 %>% filter(geo_value == 'sd')
adep_var_2 <- anxiety_2 %>% filter(geo_value == 'sd')
ddep_var_2 <- depression_2 %>% filter(geo_value == 'sd')
...
write.csv(tp1data, "C:/Users/a426f262/OneDrive - University of Kansas/Desktop/School/Research/COVID-19 and Mental Health/code + results/results/data/SouthDakota1.csv",row.names = FALSE)
write.csv(tp2data, "C:/Users/a426f262/OneDrive - University of Kansas/Desktop/School/Research/COVID-19 and Mental Health/code + results/results/data/SouthDakota2.csv",row.names = FALSE)
###### Run models ##
####FIRST TIME PERIOD###
#save J test results
...
sink('irfSouthDakota1_death.txt')
print(irfresult1_death)
sink()
#
sink('irfSouthDakota1_incidence.txt')
print(irfresult1_incidence)
sink()
#
sink('irfSouthDakota1_work.txt')
print(irfresult1_work)
sink()
#
sink('irfSouthDakota1_spent.txt')
...
pdf('irfSouthDakota1_death.pdf')
plot(irfresult1_death)
dev.off()
# tiff('irfSouthDakota1_death.tiff', res = 300)
# plot(irfresult1_death)
# dev.off()
#
pdf('irfSouthDakota1_incidence.pdf')
plot(irfresult1_incidence)
dev.off()
# tiff('irfSouthDakota1_incidence.tiff', res = 300)
# plot(irfresult1_incidence)
# dev.off()
#
pdf('irfSouthDakota1_work.pdf')
plot(irfresult1_work)
dev.off()
# tiff('irfSouthDakota1_work.tiff', res = 300)
# plot(irfresult1_work)
# dev.off()
#
pdf('irfSouthDakota1_spent.pdf')
plot(irfresult1_spent)
dev.off()
# tiff('irfSouthDakota1_spent.tiff', res = 300)
# plot(irfresult1_spent)
# dev.off()
...
#irfresult1 = irf(mdl1, boot = FALSE)
setwd("C:/Users/a426f262/OneDrive - University of Kansas/Desktop/School/Research/COVID-19 and Mental Health/code + results/results/IRF coeffs")
sink('irfSouthDakota2_death.txt')
print(irfresult2_death)
sink()
#
sink('irfSouthDakota2_incidence.txt')
print(irfresult2_incidence)
sink()
#
sink('irfSouthDakota2_work.txt')
print(irfresult2_work)
sink()
#
sink('irfSouthDakota2_spent.txt')
print(irfresult2_spent)
sink()
#
sink('irfSouthDakota2_vac.txt')
...
#after running line: plot(irfresult1)
setwd("C:/Users/a426f262/OneDrive - University of Kansas/Desktop/School/Research/COVID-19 and Mental Health/code + results/results/IRF")
pdf('irfSouthDakota2_death.pdf')
plot(irfresult2_death)
dev.off()
# tiff('irfSouthDakota2_death.tiff', res = 300)
# plot(irfresult2_death)
# dev.off()
#
pdf('irfSouthDakota2_incidence.pdf')
plot(irfresult2_incidence)
dev.off()
# tiff('irfSouthDakota2_incidence.tiff', res = 300)
# plot(irfresult2_incidence)
# dev.off()
#
pdf('irfSouthDakota2_work.pdf')
plot(irfresult2_work)
dev.off()
# tiff('irfSouthDakota2_work.tiff', res = 300)
# plot(irfresult2_work)
# dev.off()
#
pdf('irfSouthDakota2_spent.pdf')
plot(irfresult2_spent)
dev.off()
# tiff('irfSouthDakota2_spent.tiff', res = 300)
# plot(irfresult2_spent)
# dev.off()
#
pdf('irfSouthDakota2_vac.pdf')
plot(irfresult2_vac)
dev.off()
# tiff('irfSouthDakota2_vac.tiff', res = 300)
# plot(irfresult2_vac)
# dev.off()

#save model coefficients
setwd("C:/Users/a426f262/OneDrive - University of Kansas/Desktop/School/Research/COVID-19 and Mental Health/code + results/results/Coefficients")
sink('CoeffSouthDakota2.txt')
