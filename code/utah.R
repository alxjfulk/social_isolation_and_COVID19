...
adep_var_1 <- anxiety_1 %>% filter(geo_value == 'ut')
ddep_var_1 <- depression_1 %>% filter(geo_value == 'ut')
adep_var_2 <- anxiety_2 %>% filter(geo_value == 'ut')
ddep_var_2 <- depression_2 %>% filter(geo_value == 'ut')
...
write.csv(tp1data, "C:/Users/a426f262/OneDrive - University of Kansas/Desktop/School/Research/COVID-19 and Mental Health/code + results/results/data/Utah1.csv",row.names = FALSE)
write.csv(tp2data, "C:/Users/a426f262/OneDrive - University of Kansas/Desktop/School/Research/COVID-19 and Mental Health/code + results/results/data/Utah2.csv",row.names = FALSE)
###### Run models ##
####FIRST TIME PERIOD###
#save J test results
...
sink('irfUtah1_death.txt')
print(irfresult1_death)
sink()
#
sink('irfUtah1_incidence.txt')
print(irfresult1_incidence)
sink()
#
sink('irfUtah1_work.txt')
print(irfresult1_work)
sink()
#
sink('irfUtah1_spent.txt')
...
pdf('irfUtah1_death.pdf')
plot(irfresult1_death)
dev.off()
# tiff('irfUtah1_death.tiff', res = 300)
# plot(irfresult1_death)
# dev.off()
#
pdf('irfUtah1_incidence.pdf')
plot(irfresult1_incidence)
dev.off()
# tiff('irfUtah1_incidence.tiff', res = 300)
# plot(irfresult1_incidence)
# dev.off()
#
pdf('irfUtah1_work.pdf')
plot(irfresult1_work)
dev.off()
# tiff('irfUtah1_work.tiff', res = 300)
# plot(irfresult1_work)
# dev.off()
#
pdf('irfUtah1_spent.pdf')
plot(irfresult1_spent)
dev.off()
# tiff('irfUtah1_spent.tiff', res = 300)
# plot(irfresult1_spent)
# dev.off()
...
#irfresult1 = irf(mdl1, boot = FALSE)
setwd("C:/Users/a426f262/OneDrive - University of Kansas/Desktop/School/Research/COVID-19 and Mental Health/code + results/results/IRF coeffs")
sink('irfUtah2_death.txt')
print(irfresult2_death)
sink()
#
sink('irfUtah2_incidence.txt')
print(irfresult2_incidence)
sink()
#
sink('irfUtah2_work.txt')
print(irfresult2_work)
sink()
#
sink('irfUtah2_spent.txt')
print(irfresult2_spent)
sink()
#
sink('irfUtah2_vac.txt')
...
#after running line: plot(irfresult1)
setwd("C:/Users/a426f262/OneDrive - University of Kansas/Desktop/School/Research/COVID-19 and Mental Health/code + results/results/IRF")
pdf('irfUtah2_death.pdf')
plot(irfresult2_death)
dev.off()
# tiff('irfUtah2_death.tiff', res = 300)
# plot(irfresult2_death)
# dev.off()
#
pdf('irfUtah2_incidence.pdf')
plot(irfresult2_incidence)
dev.off()
# tiff('irfUtah2_incidence.tiff', res = 300)
# plot(irfresult2_incidence)
# dev.off()
#
pdf('irfUtah2_work.pdf')
plot(irfresult2_work)
dev.off()
# tiff('irfUtah2_work.tiff', res = 300)
# plot(irfresult2_work)
# dev.off()
#
pdf('irfUtah2_spent.pdf')
plot(irfresult2_spent)
dev.off()
# tiff('irfUtah2_spent.tiff', res = 300)
# plot(irfresult2_spent)
# dev.off()
#
pdf('irfUtah2_vac.pdf')
plot(irfresult2_vac)
dev.off()
# tiff('irfUtah2_vac.tiff', res = 300)
# plot(irfresult2_vac)
# dev.off()
